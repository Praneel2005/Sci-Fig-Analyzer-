...
prompt = "Describe this scientific figure in detail. Include the figure type, axes, trends, and key conclusion. Write 100-150 words. Do not invent methodology."

# Pick the same 5 test figures
...
for img_name in selected:
    ...
    with torch.no_grad():
        # THE FIX: Add generation constraints
        out = model.generate(
            **inputs, 
            max_new_tokens=200,
